...
#
# Order matters. 01 opens <html><head><style> and <body>; 06 closes </body></html>.
#
...
PARTS=(
  ...
  src/02_article.html # title, Mayo's definition, the scenario, control/figure mounts, footer
  src/03_lib.js       # dnorm/pnorm/qnorm, canvas renderer, drag plumbing, DOM helpers
  src/04_core.js      # state, severity thresholds, colours, plot helpers
  src/05_severity.js  # the water plant: severity curve, densities, table, prose
  src/06_close.js     # initial mount, closes </body></html>
)
