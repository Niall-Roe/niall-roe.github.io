...
This is on the way to being great. 

But I want to simulate working through it. Start with raw data. then get the opportunity to make the decisions he makes, and crawl through bit by bit, showing bin counts etc. you could even have the user try to flag when they think they are at a standard, or where one was, and note where peirce made those decisions. 

it should really show how he smoothed things. how did he know or calculate the smoothed value for a given bin? lets make it clear. 

I suppose the separation is a judgement call, or did he have a formulaic way to do that?

Make the text say:

The text here is from pages xx-yy of MS 427, and is the version published in xx and yy. However, the published version is actually Peirce's second attempt at this example. Here, where he says it is clearly 5 standards, it is because he had previously worked it out (though originally thought there were x standards). 

His method was to tally all 158 weights into half-grain sized "bins". He did this in order, and as he proceeded, he noted where there were apparent peaks or changes. e.g., after noting that there were only 6 weights in the 139.2-139.6 bin, he notes “The numbers begin to fall off. But not so fast as they should, for now we are probably approaching another standard” 

He recorded these numbers in a table with headings  App[arent]. standard · No. weights · Smoothed · Separated.
...
There are many pages of Peirce working this out. it would be cool to have an image of one of those pages and then walk the user through the math.
