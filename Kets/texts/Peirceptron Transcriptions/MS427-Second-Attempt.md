# MS 427 — Second Attempt

Source: `338.pdf`, pages 15–24 (pipeline frames 00015–00024).

The revised draft, headed 'The Kets of Naucratis' in the margin. This is the version printed in EP2 pp. 119-120.
...
Mr. Petre has calculated the value of the best to a tenth of a
...
case, I give a diagram upon which the abscissas
...
with circles about them are these actual observations
In order to represent these observations, I have
...
our own whose ordinates are the sums of those of the
blue ones and which would pass through every red dot
if it were to represent the observations with mechanical
accuracy. I repeat that this theory has not been the subject
any but the simplest calculations. It is obvious that some
theory must be true; but to decide how near my theory
probably comes to the true theory or how it ought to be mod
would be a very intricate problem for the solution of which
...
merge into one another inevcibly
...
of that empire together. Even their religious were
ferant; so that a fortiori their bets would be so. Besides, none
nots carry any authoritative mark; which is pretty
conclusive proof that the central government did not inter
verse. It is, therefore, probable that the five standards were
those of five towns with which Nancratis carried on trade
...
of imparting definiteness to the problem. Such as is the
of data given by Petre, it is insufficient
apparently, for determining the true law of those departures
the workmen were sufficiently skillful. (as I believe they
would be) the departures would follow the
probability curve. But if they were unskillful, it would be
desirable to ascertain by what process the weights were made
The weights, being of stone, are not loaded; so that the admit
ment was made by grinding, exclusively? Did the work
man, then have a balance by his side, or did he ﬁnish the
weight by guess-work? In the latter case, inspection
and some sort of inspection there must, in this case, have been
the same number of the
```

## 338.pdf p.21  ·  frame 00427_0021

```
would reject all weights outside a certain "tolerance," as it
is called in coinage. Those that were too light would have to
between away. They would lie in a heap, until they reapp
peared to deceive a future archeologist. But the
somewhat heavier, than independent evidence would lead us
e the bit to have been.) Those that were too heavy would
be overounded, but would for the most part still be rather
heavier than the standard. The consequence would be that
the curve would be cut modern vertically at two ordinates
equally distant, perhaps, from the standard), (which the ord
of its maximum would be at the right of that of the standard
the workman had a balance at hand, and frequently used
it during the process of adjustment, the form of the error
curve would depend upon the construction of the balance
...
class the existence of whose members is due to a common and pe
Causation in final name. It is, as I was saying, a wide-spread error to think
a "final cause" is necessarily a
```
...
the efficient, or foraful; and the ideal, or final. If we are
conserve the truth of that statement, we must understand by
final causation that mode of bringing facts about
according to which a general description of result is
made to come and quite irrespective of any compulsion
it to be made in this or that particular way; although the
may be adapted to the end. The general result may be
brought about at one time in one way, and at an
in another way. Final causation does not determin
