# MS 427 — First Attempt

Source: `371.pdf`, pages 5–23 (pipeline frames 00343–00361).

Peirce's earlier draft. Frames 343-344 are two openings of the same first page; frames 345-352 are calculation slips and tables.
...
```
mention an incontatible instance of it; · incomteible, I mean
...
```
mention an incontestible instance of it; · incontistible, I mean
by any fair mind competent to deal with the question. That
admissible reasoner, Prof. Flinders Fatre; found at the ancient
toun of Naucratis 158 weights having the Egyptian
Let as their unit. The great majority were of the most unchanged
material, so that only one in eight required any correction to
bring them to state ancient amount; and in the majority of cases
the convictions do not exceed 7 per cent. There cannot well have
been many weights which did not come within two per cent of
stands at which they aimed; and this estimate is confirm
by the fact that bisecting the number of weights between the lightest weight and
lightest inferred standard, as well as that between the heartest way
and the heaviest inferred standard, we get in the two cases weights differing
those inferred standards by 1st and 0.9 grains, or 0. 7 of one perce
...
```
hts are small, and were therefore used for weighing
or precious matter, our knowledge of ancient metrol
...
of two or even three standards a given balance-weight
...
```
Logic. We may be confident that there was another standard at
about 149 grains. Here, then, are at least three natural
and real classes of weights, aiming respectively at standard
of 140, 145, and 149 grains; and it is not unlikely
there is another at about 142° grains. But it is utterly
...
be merged into one another; and that has certainly been shown
whatever the facts of this particular case may be. Still, one
lies to perfect an illustration, and especially in a work
upon logic, it is well to make illustrations of reasoning
rather to fulfill than two meagre. I will, therefore, go a bit out of the
the same number of the
```

## 371.pdf p.16  ·  frame 00427_0354

```
way, to be whether my procedure was sound. The objection is
that after the weights were made, some considerable part of them
might have been refuted as being too light or too heavy beyond
the "tolerance," as we call it, in coin age. The result would be
the entire removal of all outside these limits making the
descent of the curve at both ends very sudden. Therefore the
error calculated as I have calculated it, from these
slopes would be much smaller than the true probable error. This
extremely plausible yet upon careful exam
nation it seems to be unsound. The first place, I will
show that the phenomenon this objection supposes
was by no means certain to present itself, but
that whether it did so or not would depend upon what
the process of making the weights was. I will then show
...
without resorting to a balance; and that after they were so
finished, they were all tried and the bad ones were rejected
If, however, a balance was employed, it must have been such
a balance as is shown on the Egyptian monuments. Now all
the balances shown there are equal-armed balances; but they
are of two varieties. For some of them have the centre of
arity of the beam above the point of support, while others
the small number have it below. The latter would oscillate
like modern balances; the former would remain with one
ide down until a greater weight was put into the opposite
...
```
Logic logic, and afford little indication that the two are
nearly equal. For, with equal weights in each pan, they
will rest unmoved in either position, instead of oscillating
like a modern balance. The second conceivable way of
making a weight, then, would be for the work man to have
at his hand one of these top-heavy balances with the
maximum allowable weight in it, and to grind down
his stone weight until it ceased to throw the balance
over. Subsequently, it would be necessary to ascertain
whether it would throw over the lightest allowable weight
...
our calculations from the light weights is only a triple larger than
from the heavy ones; so that the effect is not serious, if this first
method was used. This is the modern method of coinage, except
...
```
e a mixture of timidity and rashness among the dif
t workmen that the calculated probable error would
le as much too small when derived from the light as from
the heavy weights. But this would be an improbable result
If the work men were few, one might make his
one little and another at another, and thus there would be
...
the use of sellers; and some of the virtual standards may
perhaps where had their origin in that. This is somewhat borne
...
```
had its own pound. So my article "pound in the Century
tionary, which was based on a list of some three him
d grounds known to me, with their values, which list I dep
...
```
any definite value, but would simply grind away
kindly, trying his weight every time he had ground
off about as much as the whole permissible range of vari
ation. Could he guess at that exactly, his error curve would
be rectiliner; and so it would if he always ground off the
same amount. But since there would be some our ability
which would probably follow the probability curve, his
arrow-curve would have a contrary figure at its lowest part
All this is aside from our present purpose; but
it will be referred to with interest when we come to study that theory of errors
I hope this long digression will not have caused the reader
that we were engaged in considering some of the
consequences of understanding the term "natural," or
real," class to mean a class the existence of whose members
