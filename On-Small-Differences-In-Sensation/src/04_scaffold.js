...
/* ==========================================================================
   ...
   Carried over unchanged from the Probability of Induction edition, so that
   the two papers behave identically: the same trigger, the same growth, the
   same rule that the text on the page is the authors' unless you are actively
   driving it.
   ========================================================================*/
