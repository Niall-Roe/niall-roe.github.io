...
Nothing is built yet. This is the survey pass: every place in the paper where I
think an interactive example earns its keep, numbered in the order it appears in
the text, with the passage it would hang off and what it would do.
...
Errors of Observation notes. Nothing built yet.)
